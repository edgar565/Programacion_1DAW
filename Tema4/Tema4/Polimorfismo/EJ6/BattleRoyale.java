    ...
    public static void main(String[] args) {
        ...
        while (combatientes.size() > 1) {
            ...
            for (int i = 0; i < combatientes.size() - 1; i++) {
                ...
                System.out.println("El combatiente: " + combatiente.toString());
                ICombatiente objetivo = combatientes.get(random.nextInt(0, combatientes.size()));
                System.out.println("Ataca a: " + objetivo.toString());
                if (combatiente.estaVivo()) {
                    Ataque ataque = combatiente.atacar();
                    objetivo.defender(ataque);
                    if (!objetivo.estaVivo()) {
                        System.out.println("El combatiente: " + combatiente.toString() + " es el vencedor de esta ronda");
        ...
        System.out.println("¡El vencedor del Battle Royale es: " + ganador.toString() + "!");
    }
}