...
public class PracticaCombateFunciones {
    ...
    static int ataque1 = 0;
    static int defensa1 = 0;
    static int vida1 = 0;
    static int velocidad2 = 0;
    static int ataque2 = 0;
    static int defensa2 = 0;
    static int vida2 = 0;
    static int habilidad1 = 0;
    static int habilidad2 = 0;
    static int aleatorioDaño = random1.nextInt(-2, -1);
    static int aleatorioHabilidad1 = random.nextInt(1, 3);
    static int aleatorioHabilidad2 = random.nextInt(1, 3);
    static int aleatorioVelocidad1 = random.nextInt(1, 100);
    static int aleatorioAtaque1 = random.nextInt(1, 100);
    static int aleatorioDefensa1 = random.nextInt(1, 100);
    static int aleatorioVelocidad2 = random.nextInt(1, 100);
    static int aleatorioAtaque2 = random.nextInt(1, 100);
    static int aleatorioDefensa2 = random.nextInt(1, 100);
    static int daño;
    static int velocidadaño = 0;
    static int dañofinal = 0;
    static String continuar;
    static String critico;
    static String regeneracion;
    static int contadorRondas = 1;
    static int aleatorio;
    static int criticoMenu;
    static int regeneracionMenu;
    static int estadoMenu;
    ...
    public static void critico(int criticoMenu) {
        ...
        if (criticoMenu == 1 && (vida1 > 35 && velocidad1 > 60 && ataque1 > 45)) {
            result = true;
        }
        if (criticoMenu == 2 && (vida2 > 35 && velocidad2 > 60 && ataque2 > 45)) {
            result = true;
        }
        if (result == true){
    ...
    public static void estado(int estadoMenu) {
